            ...
            <div className='flex py-5 justify-between'>
              <div>
                <div className='my-2'>
                  ...
                  <p className='text-md font-medium pt-1'>{student?.whatsappNumber}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Contact Number</small>
                  <p className='text-md font-medium pt-1'>{student?.contactNumber}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Location</small>
                  <p className='text-md font-medium pt-1'>{student?.location}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>District</small>
                  <p className='text-md font-medium pt-1'>{student?.district}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Highest Level of Education</small>
                  <p className='text-md font-medium pt-1'>{student?.highestLevelEducation}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Study Area</small>
                  <p className='text-md font-medium pt-1'>{student?.studyArea}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Mark Percentage</small>
                  <p className='text-md font-medium pt-1'>{student?.markPercentage}</p>
                </div>
              </div>
              <div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Completion Year</small>
                  <p className='text-md font-medium pt-1'>{student?.completionYear}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>IELTS Score</small>
                  <p className='text-md font-medium pt-1'>{student?.ieltsScore}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Preffered Country</small>
                  <p className='text-md font-medium pt-1'>{student?.prefferedCountry}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Preffered Program</small>
                  <p className='text-md font-medium pt-1'>{student?.prefferedProgram}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Email</small>
                  <p className='text-md font-medium pt-1'>{student?.email}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Tele-Caller</small>
                  <p className='text-md font-medium pt-1'>{student?.teleCaller}</p>
                </div>
                <div className='my-2'>
                  <small className='font-medium text-gray-600'>Message</small>
                  <p className='text-md font-medium pt-1'>{student?.message}</p>
                </div>
              </div>
            </div>
          </div>
